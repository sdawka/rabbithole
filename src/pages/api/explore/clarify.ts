...
import { callLLM, extractKeys } from '../../../engine/openrouter.js';
...
Return ONLY valid JSON, no markdown fences:
{
  ...
  try {
    const response = await callLLM(keys, prompt, 'Return only valid JSON. No explanation outside the JSON.', null);
